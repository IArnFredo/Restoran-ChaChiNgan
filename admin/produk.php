		  ...
		  if($ukuran_file <= 5000000){
			if(move_uploaded_file($tmp_file, $path)){
			  ...
			  if($sql){
					...
					echo '<script>alert("Berhasil Menambah Data."); document.location="produk.php"; </script>';
...
<head>
    ...
    <title>Kelola Produk - Cha Chi Ngan Restaurant</title>
    ...
    <div class="page-container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-4 clearfix">
                        <ul class="notification-area pull-right">
														<li><h3>Cha Chi Ngan Restaurant</h3></li>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td>
														<a href="edit.php?id=<?php echo $p['idproduk']?>" class="btn btn-secondary btn-md">Edit</a>
														<a href="delete.php?id=<?php echo $p['idproduk']?>" class="btn btn-danger btn-md" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
													</td>
        ...
        <footer>
            <div class="footer-area">
                <p>By Cha Chi Ngan Restaurant</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="produk.php" method="post" enctype="multipart/form-data" >
								...
								<div class="form-group">
									<label>Gambar</label>
									<input name="uploadgambar" type="file" accept="image/jpeg" class="form-control">
								</div>
