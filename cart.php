...
if(!isset($_SESSION['log'])){
	...
	$fetc = mysqli_fetch_assoc($caricart);
...
<html>
<head>
<title>Cha Chi Ngan - My Cart</title>
<link rel="icon"
	type="image/png"
...
<meta name="keywords" content="CHA CHI NGAN" />
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h2>In Your Cart : <span><?php echo $itungtrans3 ?> item</span></h2>
