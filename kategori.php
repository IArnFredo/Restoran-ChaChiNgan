...
<html>
<head>
<title>Cha Chi Ngan - Category</title>
<link rel="icon"
	type="image/png"
...
<!--- beverages --->
	<div class="products">
		<div class="container">
			<div data-aos="fade-right" class="col-md-4 products-left">
			...
			<div class="col-md-8 products-right">
				...
				<?php
					...
					?>
						...
						<div data-aos="fade-right" class="col-md-4 top_brand_left">
									...
									<figure>
										<div class="snipcart-item block">
											...
											<div class="snipcart-details top_brand_home_details">
												<fieldset>
													<a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><input type="submit" class="button" value="See Menu" /></a>
												</fieldset>
											</div>
										</div>
									</figure>
