...
<html>
<head>
<title>Cha Chi Ngan - Produk</title>
<link rel="icon"
	type="image/png"
			...
			<div class="agileinfo_single">
				...
				<h2><?php echo $p['namaproduk'] ?></h2>
					...
					<div class="w3agile_description">
						...
						<p><?php
						$idcat = $p['idkategori'];
						$sel = mysqli_query($conn,"SELECT * from kategori WHERE idkategori = '$idcat' ");
						$kategori = mysqli_fetch_array($sel);
						echo $kategori['namakategori'] ?></p>
					</div>
					<div class="w3agile_description">
						<h4>Description :</h4>
